      ...
      <div className="row">
        ...
        <section className="h-100 bisection bisection-2 col-lg-6">
          ...
          <ul className="skills-ul">
            <li className="skills-li"><img src={css} className="skills-img col-6" type="image" alt="css" /><span className="col-6"> CSS</span></li>
            <li className="skills-li"><img src={express} className="skills-img col-6" type="image" alt="express" /><span className="col-6"> express.js</span></li>
            <li className="skills-li"><img src={handlebars} className="skills-img col-6" type="image" alt="handlebars" /><span className="col-6"> Handlebars.js</span></li>
            <li className="skills-li"><img src={html} className="skills-img col-6" type="image" alt="html" /><span className="col-6"> HTML</span></li>
            <li className="skills-li"><img src={js} className="skills-img col-6" type="image" alt="javascript" /><span className="col-6"> JavaScript</span></li>
            <li className="skills-li"><img src={mongodb} className="skills-img col-6" type="image" alt="mongodb" /><span className="col-6"> MongoDB</span></li>
            <li className="skills-li"><img src={mysql} className="skills-img col-6" type="image" alt="mysql" /><span className="col-6"> MySQL</span></li>
            <li className="skills-li"><img src={nodejs} className="skills-img col-6" type="image" alt="nodejs" /><span className="col-6"> Node.js</span></li>
            <li className="skills-li"><img src={react} className="skills-img col-6" type="image" alt="react" /><span className="col-6"> React</span></li>
