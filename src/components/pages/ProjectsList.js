      ...
      <div className="shadow card-style card">
        ...
        <div className="card-body project-card" >
          ...
          <div className="center">
            ...
            <button className="btn btn-secondary mx-1 project-btn"> <a href={props.project.appUrl} className="project-link" target="_blank" rel="noreferrer">Demo</a></button>
            <button className="btn btn-secondary mx-1 project-btn"> <a href={props.project.gitUrl} className="project-link" target="_blank" rel="noreferrer">Git</a></button>
          </div>
        </div>
      </div>
    </div>
